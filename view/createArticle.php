    ...
    <div class="flex justify-center items-center py-8">
        <form action="?op=create-article" method="post" enctype='multipart/form-data' class="max-w-lg border border-gray-200 shadow-xs mx-auto rounded-lg p-10 bg-white text-center space-y-6 flex-grow">
            <div class="flex flex-col">
                ...
                <input type="text" id="titel" placeholder="title" name="title" class="outline-none px-2 py-2 border shadow-sm placeholder-gray-500 opacity-50 rounded">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" id="author" name="author" placeholder="Auteur" class="outline-none px-2 py-2 border shadow-sm placeholder-gray-500 opacity-50 rounded">
            </div>
